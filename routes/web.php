...
Route::namespace('Admin')->prefix('admin')->name('admin.')->middleware(['auth','can:admin-access'])->group(function () {
    ...
    // == ROUTE PENGGAJIAN == //
    // Route untuk menampilkan halaman utama penggajian
    Route::get('/penggajian', 'PenggajianController@index')->name('penggajian.index');
    // Route untuk menampilkan form tambah gaji
    Route::get('/penggajian/tambah', 'PenggajianController@create')->name('penggajian.create');
    // Route untuk MENYIMPAN data gaji baru
Route::post('/penggajian', 'PenggajianController@store')->name('penggajian.store');
});
