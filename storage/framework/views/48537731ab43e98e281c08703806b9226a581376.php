                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($holiday->start_date->format('F')); ?></td>
                                        <td><?php echo e($holiday->start_date->format('d')); ?></td>
                                        <?php if($holiday->end_date): ?> 
                                        <td><?php echo e($holiday->end_date->format('d')); ?></td>
                                        <?php else: ?>
                                        <td>Sehari</td>
                                        <?php endif; ?>
                                        <td>
                                            <a href="<?php echo e(route('admin.holidays.edit', $holiday->id)); ?>" class="btn btn-flat btn-warning">Edit</a>
                                            <button 
                            ...
                            <?php for($i = 1; $i < $holidays->count()+1; $i++): ?>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            <div class="card card-danger">
                                                ...
                                                <div class="card-body text-center d-flex" style="justify-content: center">
                                                    ...
                                                    <form 
                                                    action="<?php echo e(route('admin.holidays.delete', $holidays->get($i-1)->id)); ?>"
                                                    method="POST"
                                                    >
                                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel_absensi\resources\views/admin/holidays/index.blade.php ENDPATH**/ ?>